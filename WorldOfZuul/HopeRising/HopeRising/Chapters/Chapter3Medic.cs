...
namespace HopeRising
{
    public class Chapter3Medic : IChapter // Ensure it implements IChapter
    {
        ...
        public void CreateRoomsAndQuests()
        {
            ...
            Item Herbs = new Item("Fragrant Herbs", "This herbs will come in handy to disover new medicines", "You'll discover new kind of herbs when you'll explore the forest");
            ...
            Item Medicines = new Item("Freshly Discovered Medicines", "They will come in handy to help the miners in cave", "You need to discover new medicines in Medical Lab...");
            ...
            PublicHospital.SetExits(MedicalLab, null, OldRanch, VillageCenter);

            TownMarket.SetExits(VillageCenter, OldRanch, null, null);
        ...
        private int HospitalPatients()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine(TextArtManager.GetTextArt("MedicSyringe"));
                Console.WriteLine("\n > Choose an action:");
            ...
            static void TreatPatient()
            {
                if (medicalSupplies > 0)
                {
                    ...
                    if (treatmentResult <= 7) // 70% success rate
                    {
        ...
        public int RescueAnimals()
        {
            ...
            // Sample animals
            Animal deer = new Animal("Wapiti Deer", "Deer");
            Animal cat = new Animal("Grey Cat", "Cat");
            Animal cow = new Animal("White Cow", "Cow");
            Animal horse = new Animal("Mustang Horse", "Horse");
                ...
                switch (choice)
                {
                    case "1":
                        foreach (var animal in clinic.Animals)
                        {
                            ...
                            Console.WriteLine($"\n > {animal.Name} is {(animal.IsHealthy ? "now healthy!" : "still unwell.")}");
                        ...
                        {
                            Console.WriteLine(" > Congratulations! You cured 3 animals. Now you can go and inform Farmer!");
        ...
        private int MinerRescue()
        {
            ...
            Console.WriteLine(" > You are a tasked with finding and healing injured miners in a cave.");
            Console.WriteLine(" > You have three possible locations to search.");
            Console.WriteLine(" > You need to find at least 5 of them...");
            ...
            while (minersHealed < totalMiners)
            {
                ...
                if (int.TryParse(userInput, out int location) && location >= 1 && location <= 3)
                {
                    ...
                    if (minerFound)
                    {
                        Console.WriteLine("\n > Nice! You found an injured miner in location " + location + "!");
                        Console.WriteLine("\n > You provide first aid and heal the miner.");
                        minersHealed++;
                    ...
                    {
                        Console.WriteLine("\n > No injured miners found in location " + location + ".");
            ...
            while (!gatheredAllInfo)
            {
                ...
                switch (selectedIndex)
                {
                    case 0:
                        ...
                        {
                            Console.WriteLine(TextArtManager.GetTextArt("MedicMerchant"));
                            ...
                            PrintText(" So far, I have seen that you follow the principles of the SDGs, especially point 3 regarding healthy living and well being. " +
                                      "\n Now you have to prove that you are worthy of being called an SDG Medic.");

                            PrintText(" Here you have the SDG Book. It will go with you all your life. Now go to Holy Church and finish the SDG Quiz...");

                            PrintText("\n Medic: Thank you for that! I am sure I am worthy...");
                ...
                switch (selectedIndex)
                {
                    case 0:
                        if (!infoCollected.Contains("Mayor"))
                        {
                            ...
                            Console.WriteLine(TextArtManager.GetTextArt("MedicMayor"));
                    ...
                    case 1:
                        ...
                        {
                            Console.WriteLine(TextArtManager.GetTextArt("MedicOldMan"));
                    ...
                    case 2:
                        ...
                        {
                            Console.WriteLine(TextArtManager.GetTextArt("MedicFarmer"));
        ...
        private int VillageCenterInformMayor2()
        {
            ...
            Console.WriteLine("\nFarmer animals are sick. This is not good at all. Go to ranch and help them...\n");
        ...
        private int DiscoverMedicines()
        {
            ...
            while (discoveredMedicines < 2)
            {
                ...
                Console.WriteLine("\n > You need to discover 2 new kinds of medicines. Go!:");
                Console.WriteLine("\n > 1. Research");
                Console.WriteLine("\n > 2. Experiment");
                Console.Write("\n > "); 
        ...
        private int BattleWithSickness()
        {
            ...
            // Sickness stats
            int sicknessHealth = 100;
            int sicknessAttackPower = 10;

            Console.WriteLine("\n This sickness has made citizens life miserable for so long...\n");
            Console.WriteLine("\n Do something with that Medic... \n");
            ...
            while (medicHealth > 0 && sicknessHealth > 0)
            {
                ...
                Console.WriteLine(" > 1. Attack this sickness!");
